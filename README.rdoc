...
Updates 08/29/2010
------------------
Please note that this is the version of file_manager that I will maintain going forward.  I will update this file
to more accurately reflect the changes.  But briefly, it is using Devise/Simple Forms/CanCan instead of
Authlogic/my own Ryan Bates inspired Labeled Form builder/my own roles management system.
Additionally, I have refactored the application to move Admin stuff under the Admin name space for CanCan.
I am also in the process of porting the test suite from Shoulda/WebRat/Cucumber to RSpec/Capybara/Cucumber stack.
